...
> 🚀 Built with [Adminator Generator](https://appseed.us/generator/adminator/), timestamp `2022-08-11 11:31`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/93f33f0d-9cb5-4297-8c86-ff1f2b6797a4.git
$ cd 93f33f0d-9cb5-4297-8c86-ff1f2b6797a4
```
